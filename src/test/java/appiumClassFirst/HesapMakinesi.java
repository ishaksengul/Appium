...
//* 7 çarpı 8 i konsola yazdıralım.
            ...
            WebElement carpmaIsareti = driver.findElementById("com.android.calculator2:id/op_mul");
            WebElement sayi8 = driver.findElementById("com.android.calculator2:id/digit_8");
            WebElement esittirIsareti = driver.findElementById("com.android.calculator2:id/eq");
